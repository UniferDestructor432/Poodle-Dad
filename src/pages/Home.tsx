  ...
  return (
    <IonPage>
      <IonContent fullscreen>
        <IonImg src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTI_2EDD_Caq9eueFaNi7WrB0qErupkm6M6EA&s' style={{height : '20%', justifyContent: 'center', alignContent: 'center', marginTop: '50%'}}></IonImg>
